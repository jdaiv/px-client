    ...
    render({ auth }) {
        ...
        return (
            <form class={style.form + ' ' + (auth.processing ? style.disabled : '')} onSubmit={this.login}>
                ...
                <input style="margin-bottom: 0.25rem" name="username" autocomplete="off" placeholder="username" minLength="8" maxLength="64" required="true" />
                <p class={style.hint}>username must be between 8 and 64 characters</p>
                <input style="margin-bottom: 0.25rem" name="password" type="password" placeholder="password" minLength="8" maxLength="256" required="true" />
